...
#6: Create a function called calculate_score() that takes a List of cards as input 
...
def play_game():
  ...
  #5: Deal the user and computer 2 cards each using deal_card()
  user_cards = []
  computer_cards = []
  is_game_over = False
